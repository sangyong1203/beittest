<template>
    <div class="content">
        ...
        <div class="content__list-box">
            <span v-if="data.length === 0" class="content__list-box__no-data">출역 중장지가 없습니다.</span>
            <div v-for="item in data" :key="item.company" class="content__list-box__list">
                <div class="name-box">
                    ...
                    <span class="name-box__name">{{ item.ctgo_equip_name }}</span>
                </div>
                <div class="value-box">
                    <span class="value">{{ item.cnt }}</span>
                    <span style="margin-left: 2px">대</span>
                </div>
            </div>
        </div>
    </div>
