<template>
    <div class="safety-meeting">
        <div class="safety-meeting__body">
            <!-- 리스트 -->
            <CommonContent :label="'안전회의록'" @send-search="checkContentParams">
                <safetyMeetingTable
                    :label="'안전회의록'"
                    :menu-list="menuList"
                    :data="tableData"
...
import safetyMeetingTable from "./Table.vue"
...
// 테이블 메뉴 리스트
const menuList: string[] = ["업체", "공종", "회의명", "작성자", "작성일"]
...
const getData = () => {
    ...
    api.getSafetyMeetingList(params).then((res:any) => {
        try {
