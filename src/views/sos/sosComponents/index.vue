<template>
    <div class="common-body">
        <div class="common-body__body">
            <!-- 리스트 -->
            <CommonContent :label="'SOS 요청이력'" @send-search="checkContentParams">
                <SOSTable :label="'SOS 요청이력'" :menu-list="menuList" :data="tableData" :limit="limit" :selectedPage="selectedPage" />
...
import SOSTable from "./Table.vue"
