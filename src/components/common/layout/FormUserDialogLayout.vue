<template>
    ...
    <div class="dialog">
        <div class="dialog-layout">
            ...
            <div class="dialog-layout__footer"></div>
            <div class="dialog-layout__footer">
                <BasicButton v-if="title.includes('상세') == true" :label="'얼굴사진 등록'" :theme="'normal'" @click="redirectBiostar(user_id)"></BasicButton>
...
const { title, user_id } = toRefs(props)
...
const redirectBiostar = (user_id: number) => {
    const targetURL = 'https://59.24.112.11/#/user/detail/' + user_id
    const cookies = document.cookie
    window.location.href = targetURL + '?cookies=' + encodeURIComponent(cookies)
}
